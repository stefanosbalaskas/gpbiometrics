...
## Reviewer and manuscript report templates

Helpers for generating conservative manuscript-ready methods,
quality-control, reproducibility, and audit-summary text from Gazepoint
workflow objects.
...
- [`create_gazepoint_audit_report_section()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/create_gazepoint_audit_report_section.md)
...
- [`audit_gazepoint_timecourse_grid()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/audit_gazepoint_timecourse_grid.md)
  : Audit the participant-condition-time grid for cluster-permutation
  analysis
- [`diagnose_gazepoint_cluster_design()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/diagnose_gazepoint_cluster_design.md)
  : Diagnose whether a design is suitable for cluster-permutation
  analysis
...
- [`simulate_gazepoint_cluster_timecourse_data()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/simulate_gazepoint_cluster_timecourse_data.md)
  : Simulate two-condition time-course data for cluster-permutation
  examples
...
## Remaining roadmap helpers

Final roadmap helpers for SCR recovery, pupil events, tracking, PPG
quality, event alignment, validation, and reproducibility metadata.

- [`compute_gazepoint_scr_habituation()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/compute_gazepoint_scr_habituation.md)
  : Compute SCR habituation across trials
- [`summarize_gazepoint_scr_recovery()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/summarize_gazepoint_scr_recovery.md)
...
- [`summarize_gazepoint_tracking()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/summarize_gazepoint_tracking.md)
  : Summarize Gazepoint tracking validity
- [`audit_gazepoint_pupil_luminance()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/audit_gazepoint_pupil_luminance.md)
  : Audit pupil-luminance confounding
- [`extract_gazepoint_ppg_morphology()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/extract_gazepoint_ppg_morphology.md)
  : Extract simple PPG pulse morphology metrics
- [`flag_gazepoint_ppg_quality()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/flag_gazepoint_ppg_quality.md)
  : Flag segment-level PPG quality
- [`import_gazepoint_event_log()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/import_gazepoint_event_log.md)
...
- [`assert_gazepoint_columns()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/assert_gazepoint_columns.md)
...
## Alignment, AOI, event-locked synthesis, and dashboard

Event-based stream alignment, AOI time-course preparation, multimodal
event-locked summaries, and quality-dashboard exports.
...
## Physiology and QC refinements

HRV segment QC, SCR latency metrics, multimodal signal-lag screening,
and exploratory PPG-derived respiration estimation.
...
## Export-folder intelligence

Helpers for profiling Gazepoint export folders before full workflow
execution.
...
- [`compare_gazepoint_export_profiles()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/compare_gazepoint_export_profiles.md)
  : Compare Gazepoint export-folder profiles
- [`write_gazepoint_export_profile()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/write_gazepoint_export_profile.md)
  : Write a Gazepoint export-folder profile to disk
- [`plot_gazepoint_export_profile()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/plot_gazepoint_export_profile.md)
  : Plot a Gazepoint export-folder profile

## Analysis decision logs

Helpers for recording exclusions, preprocessing choices, thresholds,
model settings, cluster-permutation settings, and reviewer-facing
workflow decisions.
...
- [`add_gazepoint_decision()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/add_gazepoint_decision.md)
  : Add a decision to a Gazepoint analysis decision log
- [`summarise_gazepoint_decision_log()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/summarise_gazepoint_decision_log.md)
...
## Design and event coverage audits

Helpers for checking participant, trial, condition, session, and event
coverage before modelling, event-window analysis, or time-course
workflows.
...
- [`plot_gazepoint_design_coverage()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/plot_gazepoint_design_coverage.md)
  : Plot Gazepoint design and event-coverage audits

## Pupil quality-control and metadata reporting

Helpers for conservative pupil-dropout detection, pupil smoothing,
missingness visualization, and metadata validation.
...
- [`summarize_gazepoint_nonwear()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/summarize_gazepoint_nonwear.md)
...
- [`export_gazepoint_audit_trail_markdown()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/export_gazepoint_audit_trail_markdown.md)
  : Export a Gazepoint audit trail as Markdown
- [`audit_gazepoint_release_readiness()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/audit_gazepoint_release_readiness.md)
  : Audit gpbiometrics release readiness
- [`summarize_gazepoint_feature_coverage()`](https://stefanosbalaskas.github.io/gpbiometrics/reference/summarize_gazepoint_feature_coverage.md)
