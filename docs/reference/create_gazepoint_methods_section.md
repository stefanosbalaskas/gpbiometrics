...
#> Gazepoint biometric workflow processing was conducted using gpbiometrics 2.1.0, an R package designed for importing, checking, preprocessing, summarising, and reporting Gazepoint Biometrics and GP3-derived biometric exports.
#>
